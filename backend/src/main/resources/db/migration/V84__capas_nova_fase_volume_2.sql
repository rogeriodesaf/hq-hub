-- No catálogo do HQ-HUB, a Coleção Clássica Marvel: Nova Fase da Panini está
-- cadastrada como volume 2. Os itens 4, 13 e 22 da ordem pertencem a essa série.
...
SET detalhe_referencia = regexp_replace(detalhe_referencia, '^V1 ', 'V2 ')
WHERE lower(trim(titulo_referencia)) = lower('Coleção Clássica Marvel: Nova Fase')
  AND detalhe_referencia IN ('V1 #4', 'V1 #13', 'V1 #22');
