-- Correcao da V352: no catalogo importado, "1a Serie" nao faz parte do
-- titulo/descricao. A identidade correta e Batman, Abril, volume 1.
...
WITH capas(numero, url_capa) AS (
    ...
    WHERE hqhub_normalizar_titulo_serie(editora.nome) LIKE 'abril%'
      AND hqhub_normalizar_titulo_serie(serie.titulo) = 'batman'
