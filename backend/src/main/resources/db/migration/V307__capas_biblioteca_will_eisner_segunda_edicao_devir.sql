-- Vincula as capas oficiais da Devir a Biblioteca Will Eisner (2a Edicao).

UPDATE series serie
SET descricao = 'Segunda edicao da colecao em dois volumes que reune graphic novels de Will Eisner.',
    ano_inicio = 2023,
    ano_fim = 2023,
    fonte_externa = 'DEVIR',
    id_externo = 'DEV111639-DEV111640-2ED',
...
WHERE editora.id = serie.editora_id
  ...
  AND hqhub_normalizar_titulo_serie(serie.titulo) =
      hqhub_normalizar_titulo_serie('Biblioteca Will Eisner (2ª Edição)');
...
SELECT capa.numero, capa.titulo,
       'Segunda edicao brasileira da Biblioteca Will Eisner publicada pela Devir.',
       capa.data_publicacao, capa.url_capa,
       '19 x 26 cm, preto e branco, brochura com orelhas',
