-- Inclui a segunda edicao de Batman & Mulher-Gato - Rastro de Polvora,
-- ausente da API de busca da Rika por estar esgotada, mas ainda publicada.
WITH capa(numero, url_capa, url_origem) AS (
    VALUES
        (2,
         'https://rika.vteximg.com.br/arquivos/ids/220321/-herois_panini-batman-mul-gato-rastro-02.jpg',
         'https://www.rika.com.br/batman-e-mulher-gato---rastro-de-polvora--215000498/p')
), edicoes_alvo AS (
    SELECT edicao.id,
