-- Cadastra as duas partes da minissérie Hellboy: Sementes da Destruição (Mythos).
...
WITH serie_alvo AS (
    ...
    ('1', 'Hellboy: Sementes da Destruição', 'Parte 1 de 2',
     ...
     52, 'hellboy-sementes-destruicao-mythos-1',
    ...
    ('2', 'Hellboy: Sementes da Destruição', 'O Covil do Demônio — Parte 2 de 2',
     ...
     52, 'hellboy-sementes-destruicao-mythos-2',
...
SELECT volume.numero, volume.titulo, volume.nome_volume, volume.url_capa,
       volume.quantidade_paginas, '17 x 26 cm, colorido, capa cartão',
       'LOJISTAS_BRASILEIROS', volume.id_externo, volume.url_origem,
