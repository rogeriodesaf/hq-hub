-- Cadastra Guardioes da Galaxia & X-Men: O Vortice Negro (Panini, 2018),
-- adiciona a capa oficial e vincula a edicao unica ao guia mutante.
...
SELECT
    'Guardiões da Galáxia & X-Men: O Vórtice Negro',
    'Encadernado Panini que reune o crossover cosmico O Vortice Negro.',
    2018,
    2018,
    1,
    'PANINI',
    'PANINI-GUARDIOES-X-MEN-VORTICE-NEGRO',
    'https://panini.com.br/guardioes-da-galaxia-e-x-men-o-vortice-negro',
    editora.id,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
...
WITH serie_alvo AS (
    ...
    WHERE lower(trim(editora.nome)) = 'panini'
      AND hqhub_normalizar_titulo_serie(serie.titulo) =
          hqhub_normalizar_titulo_serie('Guardiões da Galáxia & X-Men: O Vórtice Negro')
...
SELECT
    'UNICA',
    'Guardiões da Galáxia & X-Men: O Vórtice Negro',
    'https://d14d9vp3wdof84.cloudfront.net/image/589816272436/image_pjqlesr19t457ccflt9q76hn1k/-S265-FWEBP',
    'PANINI',
    'ALIZS001',
    'https://panini.com.br/guardioes-da-galaxia-e-x-men-o-vortice-negro',
    serie.id,
