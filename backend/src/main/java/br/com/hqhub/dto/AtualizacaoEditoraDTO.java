...
public record AtualizacaoEditoraDTO(
        @NotBlank(message = "Nome da editora é obrigatório.")
        @Size(max = 255, message = "Nome da editora deve ter no máximo 255 caracteres.")
        String nome,

        @Size(max = 1000, message = "Descrição da editora deve ter no máximo 1000 caracteres.")
        String descricao,
