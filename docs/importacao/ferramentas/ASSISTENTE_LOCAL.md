# Assistente local do Coleciona HQ

O assistente local permite que a página de importação do Coleciona HQ use uma sessão
...
4. abre a página de importação do Coleciona HQ.
...
- Apenas o domínio oficial do Coleciona HQ e endereços locais de desenvolvimento são
...
O frontend do Coleciona HQ usa a porta padrão `8765`.
...
Coleciona HQ; ele não é salvo em arquivo nem retornado pelos endpoints locais.
...
Coleciona HQ para iniciar a segunda. O assistente reserva os slots **Robô 1** e
