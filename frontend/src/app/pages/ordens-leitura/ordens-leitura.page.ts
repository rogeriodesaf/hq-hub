...
@Component({
  ...
  styles: [`
    .credito-guia{margin:16px 0 12px;padding:18px 20px;border-left:5px solid #ee7d20;border-radius:12px;background:var(--superficie-2);font-size:clamp(1.15rem,2.5vw,1.55rem);font-weight:800;line-height:1.45;color:var(--texto)}
    .credito-guia a{display:inline-block;margin-left:4px;padding:4px 10px;border-radius:8px;background:#ee7d20;color:#20150c;font-weight:900;text-decoration:none;box-shadow:0 4px 12px #0003}
    .credito-guia a:hover,.credito-guia a:focus-visible{filter:brightness(1.1);text-decoration:underline}
