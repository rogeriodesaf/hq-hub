...
@Component({
              ...
              <div class="grade">
                @for (item of secao.itens; track item.id) {
                  <article class="item" [class.lido]="item.lido">
                    ...
                    <div class="dados"><h3>{{ item.titulo }}</h3><p>{{ item.detalhe || 'Guia cronológico' }}</p>
  ...
  styles: [`
    ...
    .ano-item{margin-top:5px;font-weight:700}.observacao-item{margin-top:7px;font-size:.76rem;line-height:1.35}
  `]
})
